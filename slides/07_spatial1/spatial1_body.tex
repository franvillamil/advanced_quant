...
\begin{itemize}[<+->]
\item Today we'll focus more on \textbf{vector} data and how to work with it (more common in social science)
\end{itemize}
...
% ----------------------------------------------------
\imageframe{../img/vectorexample1}
% ----------------------------------------------------
\note{vector types}

% ----------------------------------------------------
\imageframe{../img/vectorexample2}
% ----------------------------------------------------
\note{vector types}

% ----------------------------------------------------
\imageframe{../img/vectorexample3}
% ----------------------------------------------------
\note{vector types}

% ----------------------------------------------------
\begin{frame}
\frametitle{How does it look internally: geometry + attributes}
\centering
...
\begin{itemize}
\item Grid of equal-size cells, each storing a value (elevation, precipitation, \ldots), which are \textbf{georeferenced}
...
% ----------------------------------------------------
\imageframe{../img/raster-concept}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/raster_bands}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/spain_raster1}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/spain_raster2}
% ----------------------------------------------------
\note{explain more stuff on raster data}
...
% ----------------------------------------------------
\imageframe{../img/spain_raster3}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/spain_raster4}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/spain_raster5}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/spain_raster6}
% ----------------------------------------------------
\note{explain more stuff on raster data}
...
% ----------------------------------------------------
\imageframe{../img/hunziker1}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/hunziker2}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/hunziker3}
% ----------------------------------------------------
\note{explain more stuff on raster data}

% ----------------------------------------------------
\imageframe{../img/hunziker4}
% ----------------------------------------------------
\note{explain more stuff on raster data}
...
\item \texttt{st\_within}: point must fall \textit{inside} the polygon
  \begin{itemize}
  \item Passed as a function object: \texttt{join = st\_within}, not \texttt{st\_within()}
  \end{itemize}
\item \texttt{st\_nearest\_feature}: attach nearest polygon (even if no overlap)
...
\begin{block}{Basic map of world countries}\footnotesize
\texttt{library(ggplot2)}\\
\texttt{ggplot(world) + geom\_sf() + theme\_void()}
\end{block}
...
\begin{block}{Countries colored by GDP per capita}\footnotesize
\texttt{ggplot(world) +}\\
...
\begin{block}{Country outlines + conflict event locations}\footnotesize
\texttt{ggplot() +}\\
...
\begin{itemize}[<+->]
\item \textbf{Color scales for continuous data}, some options:
  \begin{itemize}
  ...
  \end{itemize}
\vspace{8pt}
\item \textbf{Borders}, subtle: \texttt{color = "white", linewidth = 0.1}
\vspace{8pt}
...
\vspace{8pt}
\item \textbf{Projection}, some are useful: e.g. use \texttt{coord\_sf(crs = 3035)} for Europe without reprojecting data
\end{itemize}
