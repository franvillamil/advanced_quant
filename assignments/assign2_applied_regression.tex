...
\subsection{Extra: effect size}

\begin{enumerate}[label=\alph*)]
  \item How could we know whether the effect of \code{women\_parl} is big or small?
\end{enumerate}

\newpage

% ==========================================================================
\section{Home: STAR Dataset}
% ==========================================================================
...
You can find the dataset at: \href{https://github.com/franvillamil/AQM2/tree/master/datasets/star}{github.com/franvillamil/AQM2/tree/master/datasets/star}

\begin{quote}
\textbf{Note:} Go to the \href{https://github.com/franvillamil/AQM2/raw/refs/heads/master/datasets/star/star.csv}{dataset page} in Github, right-click on the `Raw' button on the left, and copy the link. You can then use that link directly in \texttt{read.csv} in R.
\end{quote}
...
Commit/upload your \code{.R} file to your GitHub repository before the deadline. Your R script should:
