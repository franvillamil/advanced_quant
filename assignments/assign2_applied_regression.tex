...
\begin{quote}
\textbf{Note:} Go to the \href{https://github.com/franvillamil/AQM2/raw/refs/heads/master/datasets/star.csv}{dataset page} in Github, right-click on the `Raw' button on the left, and copy the link. You can then use that link directly in \texttt{read.csv} in R.
\end{quote}
