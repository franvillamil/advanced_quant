...
% ==========================================================================
\section{Part 1: In-Class Lab (QoG Dataset)}
% ==========================================================================
...
Download the QoG Standard cross-section dataset from \url{https://www.gu.se/en/quality-government/qog-data/data-downloads/standard-dataset} (CSV format), or use the file provided on the course page.
...
\begin{enumerate}[label=\alph*)]
  ...
  \begin{itemize}
    ...
    \item \code{gpp\_grnst} --- green party seat share in parliament (\%)
  \end{itemize}
