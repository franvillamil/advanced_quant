...
\setlength\itemsep{0pt}
  \item {\color{red}{\textbf{Deadline}}}: \textbf{March 12, before class}
...
Load it with \code{read.csv("presidential\_approval.csv")}. Key variables:
\begin{itemize}
...
Load it with \code{haven::read\_dta("teaching\_evals.dta")}. Key variables:
\begin{itemize}
