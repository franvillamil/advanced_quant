...
% ==========================================================================
\section{Part 1: In-Class (ANES Voter Turnout)}
% ==========================================================================
...
\begin{itemize}
  \item \href{https://github.com/franvillamil/AQM2/tree/master/datasets/anes}{github.com/franvillamil/AQM2/tree/master/datasets/anes}
\end{itemize}

\begin{enumerate}[label=\alph*)]
  \item Load the dataset. Key variables to define:
  \begin{itemize}
...
\begin{enumerate}[label=\alph*)]
  \item Compute average marginal effects for the logit model using
  \item[] \code{marginaleffects::avg\_slopes(logit)}.
...
Use the same \code{star.csv} from the \href{https://github.com/franvillamil/AQM2/tree/master/datasets/star}{course page}. Key variables for this assignment:
...
Commit your file to your GitHub repository before the deadline. Put it in a different folder, e.g. \texttt{assignment3}. Make sure your repository is public so I can access it.
